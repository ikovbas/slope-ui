    ...
    this.$get = function($window, $document, $rootScope, $sce, $locale, dateFilter, $tooltip) {
      ...
      function timepickerFactory(element, controller, config) {
        ...
        $timepicker.$onKeyDown = function(evt) {
          ...
          !lateralMove && $timepicker.select(newDate, selectedIndex, true);
  ...
  .directive('bsTimepicker', function($window, $parse, $q, $locale, dateFilter, $timepicker, $dateParser, $timeout) {
    ...
    return {
      ...
      link: function postLink(scope, element, attr, controller) {
        ...
        angular.forEach(['placement', 'container', 'delay', 'trigger', 'keyboard', 'html', 'animation', 'template', 'autoclose', 'timeType', 'timeFormat', 'modelTimeFormat', 'useNative', 'hourStep', 'minuteStep', 'length', 'arrows'], function(key) {
